...
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/aachu-identity-binder.png` (aachu_identity_binder)
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/zuv-identity-binder.png` (zuv_identity_binder)
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/couple-body-language-binder.png` (couple_body_language_binder)
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/style-binder.png` (style_binder)
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/current-request-binder.png` (current_request_binder)
- `runs/2026-06-10_22-55_couple-banter/references-used/reference-binder/expression-support-binder.png` (expression_support_binder)
